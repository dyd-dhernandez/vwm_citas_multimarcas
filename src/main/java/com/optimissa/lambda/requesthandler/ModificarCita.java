...
public class ModificarCita implements RequestHandler<ReqConsultaHorarios, List<RespConsultaHorarios>> {

    @Override
    public List<RespConsultaHorarios> handleRequest(ReqConsultaHorarios paramReq, Context context) {
    	
        context.getLogger().log("INPUT ConsultarHorarios.handleRequest: ");
